...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, io.github.jhipster.application.domain.SugerenciaProducto.class.getName());
            createCache(cm, io.github.jhipster.application.domain.SugerenciaProducto.class.getName() + ".tags");
            createCache(cm, io.github.jhipster.application.domain.SugerenciaProducto.class.getName() + ".nutrientesAdicionales");
            createCache(cm, io.github.jhipster.application.domain.NutrientesAdicionales.class.getName());
            createCache(cm, io.github.jhipster.application.domain.NutrientesAdicionales.class.getName() + ".sugerenciaProductos");
            createCache(cm, io.github.jhipster.application.domain.Tags.class.getName());
            createCache(cm, io.github.jhipster.application.domain.Tags.class.getName() + ".sugerenciaProductos");
