...
/**
 * REST controller for managing {@link io.github.jhipster.application.domain.UnidadMedida}.
 */
@RestController
@RequestMapping("/api")
public class UnidadMedidaResource {
    ...
    public UnidadMedidaResource(UnidadMedidaRepository unidadMedidaRepository) {
    ...
    public ResponseEntity<UnidadMedida> createUnidadMedida(@RequestBody UnidadMedida unidadMedida) throws URISyntaxException {
        ...
        UnidadMedida result = unidadMedidaRepository.save(unidadMedida);
    ...
    public ResponseEntity<UnidadMedida> updateUnidadMedida(@RequestBody UnidadMedida unidadMedida) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, unidadMedida.getId().toString()))
            .body(result);
    }
